    ...
    renderTasks() {
        ...
        filteredTasks.forEach((task, index) => {
            ...
            if (!task.done) {
                ...
                doneButton.classList.add('bg-green-500', 'hover:bg-green-600', 'text-white', 'px-4', 'py-2', 'rounded');
            ...
            removeButton.classList.add('bg-red-500', 'hover:bg-red-600', 'text-white', 'px-4', 'py-2', 'rounded', 'ml-2');
